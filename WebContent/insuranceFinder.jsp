...
<div class="fullHeight">
    ...
    <div class="row fullHeight" style="text-align:center;">
            <div class="searchform card shadow p-3 mb-5 bg-white rounded"
                ...
                <div class="card-header"><h2 align="center">Provider Details</h2></div>
                
                <form action="insurance" method="post">
                    <div class="form-group" style="margin-top: 10%">
                        <input type="text" class="form-control"
                            id="exampleFormControlInput1"
                            placeholder="Enter your Insurance Group Number.." required="required" name="groupNumber">
                             <button type="submit" style="margin-top: 5%" class="btn btn-info">Search</button>
                    </div>
                </form>
            </div>
    </div>
